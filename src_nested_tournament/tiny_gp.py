...
def evolve(train_dataset, test_dataset, augmented_dataset, train_target, test_target, terminals):
    ...
    for gen in range(1, GENERATIONS + 1):  
        ...
        while len(new_pop) < POP_SIZE:
            ...
            parent = nested_tournament(population, train_fitnesses, train_dataset)

            # Crossover
            if prob < XO_RATE:

                # print('CROSSOVER')
                parent2 = nested_tournament(population, train_fitnesses, train_dataset)
        ...
        # UNCOMMENT HERE TO PREVIOUS VERSION
