...
from data_speciation import read_dataset
from tiny_gp import evolve
from configs_speciation import GENERATIONS
...
def run_stdGP(ds_name):
    ...
    SAVE_PATH = f'/home/ines/Documents/tese/tiny_gp/results_speciation/{ds_name}/'
