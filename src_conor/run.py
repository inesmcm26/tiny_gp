...
def run_stdGP(ds_name):
    ...
    SAVE_PATH = f'/home/ines/Documents/tese/tiny_gp/results_conor/{ds_name}/'
    ...
    for run_nr in tqdm(range(26, 31)): # TODO: CHANGE HERE!
        ...
        best_train_fit_list, best_test_fit_list, best_ind_list, \
                 variances_list,  size_list, feats_list = \
        ...
        variance = pd.DataFrame([variances_list], columns = [i for i in range(0, GENERATIONS + 1)])
        ...
        variance.to_csv(SAVE_PATH + f'variance_run{run_nr}.csv')
