...
from configs_inverted_nested import GENERATIONS
...
def run_stdGP(ds_name):
    ...
    SAVE_PATH = f'/home/ines/Documents/tese/tiny_gp/results_inverted_tournament/{ds_name}/'
    ...
    for run_nr in tqdm(range(21, 31)): # TODO: CHANGE HERE!
        ...
        best_train_fit_list, best_test_fit_list, best_ind_list, best_of_run_gen, \
            ...
            evolve(train_dataset, test_dataset, augmented_dataset, train_target, test_target, terminals)
